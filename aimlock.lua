...
AimLockButton.Size = UDim2.new(0, 50, 0, 50)  -- Make the button square
AimLockButton.Position = UDim2.new(0.85, 0, 0.05, 0)  -- Adjust the position as needed
AimLockButton.BackgroundColor3 = Color3.new(0, 0, 0)
AimLockButton.TextColor3 = Color3.new(1, 0, 0)
AimLockButton.Font = Enum.Font.GothamBold  -- Change the font to a more stylish one
...
local function lookAtLockedTarget()
    if lockedTarget and lockedTarget.Character and lockedTarget.Character:FindFirstChild("HumanoidRootPart") then
        local targetPos = lockedTarget.Character.HumanoidRootPart.Position + Vector3.new(0, 1, 0)  -- Aim slightly lower (between head and body)
...
AimLockButton.MouseButton1Click:Connect(function()
    ...
    if aiming then
        lockedTarget = getNearestPlayerToCrosshair()
